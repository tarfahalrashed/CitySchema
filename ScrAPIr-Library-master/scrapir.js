...
//function scrAPIr(apiURL, parameters, response, numRes, format){
var defined = true;
var data=[], obj =[], allResults = [];

function scrAPIr(apiURL, numOfResults, format){
console.log("Call function scrAPIr")
 $.ajax({
                ...
                //      $("input[name='checkbox-w']:checked").each(function(){
                    for(var m=0; m < obJSON1.responses.length; ++m){
                      ...
                      if(eval(s)){
                       ...
                       }else if(obJSON1.responses[m].name=="Title"){
                            // console.log(eval("response."+obJSON1.responses[m].parameter));
                        }else{
